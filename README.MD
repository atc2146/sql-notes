...
## Other
* Be careful when doing division.  SQL automically does integer division if both the numerator and denominator are integers.  Explicit cast to floats is needed.
